# medan-magnet
Oke, siap! Ini README buat proyek "Medan Magnet" kalian, ditulis gaya mahasiswa buat presentasi atau dokumentasi internal.
...
```
medan-magnet/
├── README.md               # File ini yang lagi dibaca
├── index.html              # Halaman utama
├── hitung.html             # Halaman kalkulator buat solenoida, gaya, torsi
├── simulation.html         # Halaman simulasi & penjelasan medan magnet kawat lurus
├── kelompok.html           # Halaman info tim
├── style.css               # Stylesheet umum buat index.html & simulation.html
├── main.js                 # JavaScript buat animasi di index.html & fitur tambahan di simulation.html
├── launch.json             # Konfigurasi debugger VS Code
└── (aset lain kayak gambar contoh: zenitsu.jpg, buta.jpg, uler.jpg, codet.jpg kalo ada di sini)
```
